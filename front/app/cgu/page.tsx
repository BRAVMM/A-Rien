...
export default function cgu() {
    return (
        <div>
            ...
            <p>
                En vigueur au 23/12/2023
                Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
                des modalités de mise à disposition du site et des services par Bravmm et de définir les conditions
                d’accès et d’utilisation des services par « l'Utilisateur ».
                Les présentes CGU sont accessibles sur le site à la rubrique «CGU».
                Toute inscription ou utilisation du sWplique l'acceptation sans aucune réserve ni restriction des
                ...
                bravmm.myfdp.online se réserve le droit de modifier unilatéralement et à tout moment le contenu des
                présentes CGU.
                ARTICLE 1 : LES MENTIONS LÉGALES
                L'édition du site bravmm.myfdp.online est assurée par la Société TPM Bravmm au capital de 0 euros,
                immatriculée au RCS de Toulouse sous le numéro _______________, dont le siège social est situé
                au 40 boulvard de la marquette
                Numéro de téléphone _______________
                Adresse e-mail : _______________.
                Le Directeur de la publication est : Romain Panno
                L'hébergeur du site bravmm.myfdp.online est la société bravmm, dont le siège social est situé au 40
                boulvard de la marquette, avec le numéro de téléphone : _______________.
                ARTICLE 2 : ACCÈS AU SITE
                Le site bravmm.myfdp.online permet à l'Utilisateur un accès gratuit aux services suivants :
                Le site internet propose les services suivants :
                spotify, teams, discord, timer, etc...
                ...
                pas la responsabilité de bravmm.myfdp.online. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir
                ...
                Les sources des informations diffusées sur le site bravmm.myfdp.online sont réputées fiables mais le
                ...
                Malgré des mises à jour régulières, le site bravmm.myfdp.online ne peut être tenu responsable de la
                ...
                que soit sa forme, est interdite. Il assume les risques liés à l'utilisation de son identifiant et mot
                de
                passe. Le site décline toute responsabilité.
                Le site bravmm.myfdp.online ne peut être tenu pour responsable d’éventuels virus qui pourraient
                ...
                ces
                liens, il sortira du site bravmm.myfdp.online. Ce dernier n’a pas de contrôle sur les pages web sur
                ...
                l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site bravmm.myfdp.online.
                ...
                L’information contenue dans les cookies est utilisée pour améliorer le site bravmm.myfdp.online.
