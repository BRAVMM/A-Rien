...
const getRefreshedToken = async (refreshToken: string): Promise<string> => {
    ...
    const params = new URLSearchParams({
        ...
        scope: "openid profile offline_access email user.readwrite user.read mail.read mail.send chat.readwrite mail.readwrite", // Ajoutez ou modifiez les scopes selon les besoins
