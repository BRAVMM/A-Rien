...
import BravmmButton from "./Components/BravmmButton";
        ...
        >
          ...
          >
            ...
            >
              ...
              <StyledView className="flex flex-row justify-between items-center w-[50%] h-[20%] mt-[10%]">
                <BravmmButton
                  title="Confirm"
                  fontSize={20}
                  ...
                  onPress={async () => {
                    if (entryList.includes("")) {
                      ...
                      const result = await applyModification(entryList);
                      if (result === null) {
                        setError("Error");
                        return;
                      }
  ...
  return (
    <AnimatedBackground>
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <ModalEditProfileAttribute
          isActivated={isModalActivated}
